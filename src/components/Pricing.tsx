...
const Pricing = () => {
  return <section id="ofertas" className="py-12 md:py-20 px-4 bg-background">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
          ...
          <Card className="border border-border shadow-lg hover:shadow-xl transition-all duration-300 bg-card">
            ...
            <CardContent className="space-y-4 md:space-y-6 px-4 md:px-6 pb-4 md:pb-6">
              <div className="space-y-2 md:space-y-3">
                {["25 Livros de Colorir em PDF", "Temas Bíblicos Variados", "Acesso Vitalício", "Suporte por WhatsApp", "Garantia de 7 dias"].map((feature, i) => <div key={i} className="flex items-start gap-2 md:gap-3">
          ...
          <Card className="border-2 border-warning shadow-2xl hover:shadow-3xl transition-all duration-300 relative bg-card">
            ...
            <CardContent className="space-y-4 md:space-y-6 px-4 md:px-6 pb-4 md:pb-6">
              ...
              <div className="space-y-2 md:space-y-3">
                {[{
                text: "BÔNUS 1: 2 Novos livros/mês",
                value: "R$ 59,90"
              }, {
                text: "BÔNUS 2: Vídeos de Histórias Bíblicas",
                value: "R$ 29,90"
              }, {
                text: "BÔNUS 3: 15 Versículos Ilustrados",
                value: "R$ 19,90"
              }, {
                text: "BÔNUS 4: Calendário Bíblico Semanal",
                value: "R$ 19,90"
              }, {
                text: "BÔNUS 5: +100 Adesivos Cristãos",
                value: "R$ 8,90"
              }].map((bonus, i) => <div key={i} className="flex items-start gap-3 bg-orange/10 p-3 rounded-lg">
              ...
              <a href="https://pay.cakto.com.br/t5brsxw" target="_blank" rel="noopener noreferrer" className="w-full">
                <Button size="lg" className="w-full animate-pulse hover:animate-none bg-warning hover:bg-warning/90 text-warning-foreground font-bold text-sm md:text-base my-[15px]">
